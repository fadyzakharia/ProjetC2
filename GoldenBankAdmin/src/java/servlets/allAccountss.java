 ...
 * @author Rhea
 */
public class allAccountss extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet allAccountss</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet allAccountss at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        accountsList = accountsfacade.findByClientId(Integer.valueOf(client_id));
                
        if (accountsList == null){
            req.setAttribute("accountsList", null);
        } else {
