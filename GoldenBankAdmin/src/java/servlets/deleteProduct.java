...
public class deleteProduct extends HttpServlet {
    ...
    //    super.service(req, resp); //To change body of generated methods, choose Tools | Templates.
        ...
        if (req.getParameter("card_id") != null){
            ProductsCards card = cardsfacade.find(Integer.valueOf(req.getParameter("card_id")));
            cardsfacade.remove(card);
        }
        if (req.getParameter("loan_id") != null){
            ProductsLoans loan = loansfacade.find(Integer.valueOf(req.getParameter("loan_id")));
            loansfacade.remove(loan);
        }
