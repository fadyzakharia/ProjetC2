 ...
 * @author Rhea
 */
public class addPLoan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addPLoan</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addPLoan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ProductsLoans loan = new ProductsLoans();
        
        loan.setName(name);
        loan.setDescription(description);
        loan.setRate(Float.valueOf(rate));
        loan.setAmount(Float.valueOf(amount));
        
        loansfacade.create(loan);
