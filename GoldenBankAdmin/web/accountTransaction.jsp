<%-- 
    ...
    Created on : Jun 2, 2016, 3:23:38 PM
    Author     : Rhea
--%>
...
<html lang="en">
          	...
          	<div class="row mt">
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <form class="form-horizontal style-form" action="accountTransaction" method="POST">
                                
                                <div class="form-group">
                                    <label class="col-lg-2 col-sm-2 control-label">Account Id</label>
                                    <div class="col-lg-10">
                                        <% String account_id = request.getAttribute("account_id").toString(); %>
                                        <p class="form-control-static"><%=account_id %></p>
                                    </div>
                                </div>
                                    
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">To Account ID</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" name="account2_id" id="account2">
                                          <% List<Accounts> accounts = (List<Accounts>) request.getAttribute("accountsList");
					    ...
					    Deposit
                                        ...
                                        <label class="col-sm-2">
                                            <input type="radio" name="rdType" id="rdWithdrawal" value="Withdrawal">
                                            Withdrawal
                                        </label>
                                        <label class="col-sm-2">
                                            <input type="radio" name="rdType" id="rdTransfer" value="Transfer">
                                            Transfer
                                        </label>
                                    </div>
                                </div>
  ...
  <script>
      ...
      $(function(){
          $("#account2").val("").attr("readonly", true);
          $("#rdDeposit, #rdWithdrawal, #rdTransfer").change(function(){
              $("#account2").val("").attr("readonly", true);
              if ($("#rdTransfer").is(":checked")){
                  $("#account2").removeAttr("readonly");
                  $("#account2").focus();
              }
          })
      });
