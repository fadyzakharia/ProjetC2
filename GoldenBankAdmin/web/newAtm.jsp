<%-- 
    Document   : newAtm
    Created on : Jun 2, 2016, 12:00:21 AM
    Author     : Rhea
--%>
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> New ATM</h3>
                          
          	<div class="row mt">
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" action="addAtm" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                	    ...
                                	    <input type="radio" name="rdGenre" id="rdDollar" value="Smart" checked>
                                            Smart
                        		</label>
                                        <label class="col-sm-2">
                                            <input type="radio" name="rdGenre" id="rdLebanese" value="Normal">
                                            Normal
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label class="col-sm-2">
                                	    <input type="radio" name="rdNature" id="rdDollar" value="Internal" checked>
                                            Internal
                        		</label>
                                        <label class="col-sm-2">
                                            <input type="radio" name="rdNature" id="rdLebanese" value="External">
                                            External
                                        </label>
                                    </div>
                                </div>
